...
%% Estimate SNR
muo = squeeze(mean(abs(b_das.data(mask_o,:,:,:)).^2,1));
sigmao = squeeze(std(abs(b_das.data(mask_o,:,:,:)).^2,1));
mui = squeeze(mean(abs(b_das.data(mask_i,:,:,:)).^2,1));
sigmai = squeeze(std(abs(b_das.data(mask_i,:,:,:)).^2,1));
