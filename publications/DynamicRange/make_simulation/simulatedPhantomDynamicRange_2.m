function [sca_tot,amp_tot] = simulatedPhantomDynamicRange_2(sca_per_mm2)
...
r=4e-3;           % Radius of cyst [m]
xc=-7.5e-3;           % Position of cyst in x [m]
zc=25e-3;           % Position of cyst in z [m]
...
sca_points(2,:) =[-7.5e-3,  0, 45e-3];    % point scatterer position [m]
