classdef non_local_means_filtering < postprocess
    ...
    methods (Access = public)
        function h=non_local_means_filtering()
            ...
            h.reference= '';
            h.implemented_by={'Ole Marius Hoel Rindal <olemarius@olemarius.net>','Tore Bjåstad','The people at Mathworks'};
            h.version='v1.0.0';
        end
    end
    ...
    methods
        ...
        function out = FastNonLocalMeans3D(h, V, sigma, beta, rs, rc, ps, flag, block )
                ...
                % following paper:
                %
                %      A. Trist�n-Vega, V. Garc�a-P�rez, S. Aja-Fern�ndez, C.-F. Westin
