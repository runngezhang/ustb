...
extern"C" {
      ...
      const mxArray *prhs[])
    {
        ...
        {            
            ...
            if(!isComplex)
            {            
                planewave_beamforming_rf_v4sf(iXcoords,Nx,iZcoords,Nz,iChDataRe+in_offset,chDataSz,iOutDataRe+out_offset,params,iApodization);            
            }
            else
            {
                planewave_beamforming_iq_v4sf(iXcoords,Nx,iZcoords,Nz,iChDataRe+in_offset,iChDataIm+in_offset,chDataSz,iOutDataRe+out_offset,iOutDataIm+out_offset,params,iApodization);            
            }
#else
            if(!isComplex)
            {            
                planewave_beamforming_rf(iXcoords,Nx,iZcoords,Nz,iChDataRe+in_offset,chDataSz,iOutDataRe+out_offset,params,iApodization);            
            }
            else
            {
                planewave_beamforming_iq(iXcoords,Nx,iZcoords,Nz,iChDataRe+in_offset,iChDataIm+in_offset,chDataSz,iOutDataRe+out_offset,iOutDataIm+out_offset,params,iApodization);            
            }
#endif
