...
%Gives you the x and z velocity components - for now assuming that all
%images have the same receive direction, resulting in an effective (Doppler) angle
%half the size of the tx angle
