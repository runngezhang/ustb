...
recons.scan.z_axis=linspace(20e-3,55e-3,1024).';                   % z vector [m]
...
recons.write_video('joris_rf_cpw_linear_scan.avi',40);
...
% write a video to disk
recons.write_video('joris_rf_dw_linear_scan.avi',40);
