classdef delay_sum_tx_matlab < process
%DELAY_SUM_TX_MATLAB   Matlab implementation of the delay and sum on TX dimension of the general beamformed
%
...
%   $Last updated: 2017/05/04$
    ...
    methods (Access = public)
        function h=delay_sum_tx_matlab()
            h.name='Delay and sum TX USTB General Beamformer MATLAB';   
