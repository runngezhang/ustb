...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/Users/omrindal/Development/USTB_v2/+gui/multi_frame_gui_export.m', ...
    'lastFilename', '/Users/omrindal/Development/USTB_v2/+gui/multi_frame_gui.fig');
...
'PaperUnits','inches',...
'Units','characters',...
'Position',[241.333333333333 138.169230769231 128 40.6],...
...
'PlotBoxAspectRatio',[1 0.678861788617886 0.678861788617886],...
...
'Tag','image_handle',...
'Position',[11 2.46666666666667 105.428571428571 33.4],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500000576985884 1.00274451097804 0.500000000000007],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'ColorMode','auto',...
'Position',[0.500000476837158 -0.0349301397205589 7.105427357601e-15],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',0,...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.0284552845528455 0.500000476837158 7.105427357601e-15],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',90,...
...
'Position',[28.4285714285714 37.2 22.1428571428571 2.46666666666667],...
...
'String','Next Frame',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[76 37.2 21.7142857142857 2.6],...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[51.8571428571429 37.2 22.1428571428571 2.46666666666667],...
